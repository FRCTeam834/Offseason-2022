 ...
 * 
 * RIP Offseason 2022 - Offseason 2022
 * <3
 * 
 */
public class _SparkMaxController {
   ...
   * @param CANID
   */
  public _SparkMaxController(int CANID) {
    this(CANID, 20, 5, 5);
  }

  /** */
  public _SparkMaxController(int CANID, int updateTimestep, int velocityFilterPoints) {
   ...
   */
  public _SparkMaxController(int CANID, int updateTimestep, int velocityFilterPoints, int currentFilterPoints) {
    ...
    this.deviceInterface = new CAN(this.sparkMax.getDeviceId(), _SparkMaxController.manufacturerID, _SparkMaxController.deviceTypeID);
  ...
  public _SparkMaxController configRestoreFactoryDefaults() {
    this.sparkMax.restoreFactoryDefaults();
    return this;
  }
  public _SparkMaxController configInverted(boolean isInverted) {
    this.sparkMax.setInverted(isInverted);
    return this;
  }
  public _SparkMaxController configIdleMode(CANSparkMax.IdleMode idleMode) {
    this.sparkMax.setIdleMode(idleMode);
    return this;
  }
  public _SparkMaxController configVoltageCompensation(double voltage) {
    this.sparkMax.enableVoltageCompensation(voltage);
    return this;
  }
  public _SparkMaxController configSmartCurrentLimit(int limit) {
  ...
  public _SparkMaxController configPeriodicFramePeriods(int k0, int k1, int k2) {
  ...
  public _SparkMaxController configPeriodicFramePeriods(int k0, int k1, int k2, int k3) {
    this.sparkMax.setPeriodicFramePeriod(PeriodicFrame.kStatus0, k0);
    this.sparkMax.setPeriodicFramePeriod(PeriodicFrame.kStatus1, k1);
    this.sparkMax.setPeriodicFramePeriod(PeriodicFrame.kStatus2, k2);
  ...
  public _SparkMaxController configControlFramePeriod(int ms) {
    this.sparkMax.setControlFramePeriodMs(ms);
    return this;
  }
  public _SparkMaxController configPositionConversionFactor(double factor) {
    this.positionConversionFactor = factor;
    this.sparkMaxEncoder.setPositionConversionFactor(factor);
    return this;
  }
  public _SparkMaxController configVelocityConversionFactor(double factor) {
    this.velocityConversionFactor = factor;
    this.sparkMaxEncoder.setVelocityConversionFactor(factor);
    return this;
  }

  public _SparkMaxController configPositionControlP(double kP) {
    this.positionPIDController.setP(kP);
    return this;
  }
  public _SparkMaxController configPositionControlI(double kI) {
    this.positionPIDController.setI(kI);
    return this;
  }
  public _SparkMaxController configPositionControlD(double kD) {
    this.positionPIDController.setD(kD);
    return this;
  }
  public _SparkMaxController configPositionControlPID(double[] gains) {
  ...
  public _SparkMaxController configVelocityControlP(double kP) {
    this.velocityPIDController.setP(kP);
    return this;
  }
  public _SparkMaxController configVelocityControlI(double kI) {
    this.velocityPIDController.setI(kI);
    return this;
  }
  public _SparkMaxController configVelocityControlD(double kD) {
    this.velocityPIDController.setD(kD);
    return this;
  }
  public _SparkMaxController configVelocityControlPID(double[] gains) {
  ...
  public _SparkMaxController burnFlash() {
  ...
  public boolean isAtPosition(double position, double tolerance, boolean useEncoder) {
    return _SparkMaxController.inInclusiveRange(this.getCurrentPosition(useEncoder) - position, tolerance);
  }
  ...
  public boolean isAtVelocity(double velocity, double tolerance, boolean useEncoder) {
    return _SparkMaxController.inInclusiveRange(this.getCurrentVelocity(useEncoder) - velocity, tolerance);
  }
